/*
    ...
    Purpose:        a simple tool querying the Automatic Workload Repository and generates (hourly) reports
                    ...
                    _lot_ of reports.
    Requirements:   Should run on 12.1 and later, tested with 19.11.0 on Oracle Linux 8
...
accept v_ee_diag prompt  'Enter "y" if this database is an Enterprise Edition system licensed with the Diagnostics Pack: '
